...
namespace MvcApplication1.Models.Domain
{
        ...
        public ContentItemVersion<TContent>                 GetLastVersion<TContent>(Guid id) where TContent : class
        {
            ...
            switch (contentItem.Status)
            {
                ...
                case ContentItemStatus.PublishedAndDeletedInDraft:
                    return new ContentItemVersion<TContent> { Id = id, Content = null, Type = ContentVersionType.Draft, IsDeleted = true };
                case ContentItemStatus.Deleted:
                    return new ContentItemVersion<TContent> { Id = id, Content = null, Type = ContentVersionType.Published, IsDeleted = true };
                default:
    ...
    {
        private readonly TContent _draft;
        private readonly TContent _published;

        public ContentItem2(TContent draft, TContent published)
        {
            _draft = draft;
